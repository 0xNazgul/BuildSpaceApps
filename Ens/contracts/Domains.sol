...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Nazgul Name Service", "NNS") {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the Nazgul name service", "image": "data:image/svg+xml;base64,',
